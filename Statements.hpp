...
public:
    PrintStatement();
    PrintStatement(std::vector<ExprNode*> print_statements);
...
public:
    ForStatement();
    ForStatement(AssignmentStatement *initialAssignment, ExprNode *comparison, AssignmentStatement *counter, Statements *statements);
...
private:
    AssignmentStatement *_initialAssignment;
    ExprNode *_comparison;
    AssignmentStatement *_counter;
